...
(() => {
  ...
  function ensureEditor() {
    ...
    if (!section) return;
    if (!root) {
      // Another carousel tab (marketing / product ads) is showing: its Send would run nothing.
      const btn = section.querySelector(':scope > .cc3-video-overlay');
